...
INSERT INTO public.course VALUES (18, 'Dart: Dominando a Orienta��o a Objetos', NULL, 100, 'https://cursos.alura.com.br/certificate/432718e0-69e6-48fa-91b1-8a3631b587f3', 'https://cursos.alura.com.br/course/dart-orientacao-objetos', 7, 1);
...
INSERT INTO public.course VALUES (15, 'Persist�ncia com Flutter: crie um app com armazenamento interno', NULL, 100, 'https://cursos.alura.com.br/certificate/6db04ef1-2ab2-4f69-acf2-ae07b3232e7e', 'https://cursos.alura.com.br/course/flutter-persistencia-interna', 6, 1);
INSERT INTO public.course VALUES (14, 'React parte 1: Componentes reutiliz�veis para sua webapp', NULL, 100, 'https://cursos.alura.com.br/certificate/e04cdf23-5c5e-4495-be26-16786edd9edd', 'https://cursos.alura.com.br/course/react-componentes-reutilizaveis', 5, 1);
...
INSERT INTO public.course VALUES (30, 'UX: entenda a experi�ncia de usuário', NULL, 13, NULL, 'https://cursos.alura.com.br/course/fundamentos-ux-entendendo-experiencia-usuario', 10, 1);
...
INSERT INTO public.course VALUES (22, 'Angular parte 1: produtividade e organiza��o com framework SPA', NULL, 100, 'https://cursos.alura.com.br/certificate/b22fc80b-6561-40a9-a529-90046b87a3d9', 'https://cursos.alura.com.br/course/angular-fundamentos', 2, 1);
...
INSERT INTO public.course VALUES (5, 'Entity Framework Core parte 1: mapeando um banco pr�-existente', NULL, 100, 'https://cursos.alura.com.br/certificate/3e6b5aea-a2f5-445e-bf13-9dbbe1b9fa00', 'https://cursos.alura.com.br/course/entity-framework-core-banco-pre-existente-parte1', 3, 1);
INSERT INTO public.course VALUES (8, 'Entity Framework Core parte 2: mapeando um banco pr�-existente', NULL, 100, 'https://cursos.alura.com.br/certificate/88594523-d3f1-4fae-8225-9b655d98e751', 'https://cursos.alura.com.br/course/entity-framework-core-banco-pre-existente-parte2', 3, 1);
...
INSERT INTO public.course VALUES (28, 'SOLID com C#: princ�pios da programa��o orientada a objetos', NULL, 100, 'https://cursos.alura.com.br/certificate/d3cb8b8f-1151-48f1-b805-5737aa22230d', 'https://cursos.alura.com.br/course/solid-csharp-principios-orientacao-a-objetos', 3, 1);
...
INSERT INTO public.course VALUES (20, 'Spring Boot API Rest: Seguran�a da API, Cache e Monitoramento', NULL, 100, 'https://cursos.alura.com.br/certificate/75f39528-f18b-4301-827f-5ff549c822aa', 'https://cursos.alura.com.br/course/spring-boot-seguranca-cache-monitoramento', 1, 1);
...
INSERT INTO public.course VALUES (25, 'Testes de Integra��o: testes de SQL e DAOs automatizados em Java', NULL, 100, 'https://cursos.alura.com.br/certificate/5516aa5f-0405-417e-a740-0ca6f3716f63', 'https://cursos.alura.com.br/course/teste-integracao-sql-daos-automatizados-java', 1, 1);
INSERT INTO public.course VALUES (34, 'SOLID com Java: princ�pios da programa��o orientada a objetos', NULL, 41, NULL, 'https://cursos.alura.com.br/course/solid-orientacao-objetos-java', 1, 1);
...
INSERT INTO public.course VALUES (7, 'Asp.NET Core: uma webapp usando o padr�o MVC', NULL, 100, 'https://cursos.alura.com.br/certificate/8ec8dc7a-a79a-432f-8bec-9e87f7f07e39', 'https://cursos.alura.com.br/course/introducao-ao-mvc-com-asp-net-core', 3, 1);
...
INSERT INTO public.course VALUES (2, 'C# parte 2: Entendendo a Orienta��o a Objetos', NULL, 100, 'https://cursos.alura.com.br/certificate/e949f7cc-7aba-4fa7-9a26-7bf2e3ad6f46', 'https://cursos.alura.com.br/course/csharp-parte-2-introducao-orientacao-objetos', 3, 1);
INSERT INTO public.course VALUES (27, 'Design Patterns em Java I: boas pr�ticas de programa��o', NULL, 100, 'https://cursos.alura.com.br/certificate/483045c5-168b-4a07-a204-3b82140e0a98', 'https://cursos.alura.com.br/course/introducao-design-patterns-java', 1, 1);
...
(2, 'Com o intuíto de monitorar os serviços de replicação 
	do servidores slaves fui criado um monitor que verificava al�m de estar 
	rodando a replicação dos bancos, verificava algumas poss�veis divergências 
...
(3, 'Devido ao serviço de BI funcionar em um servidor r�plica e usarmos algumas tabelas auxiliares, 
era necess�rio fazer um backup periódicamente apenas destas tabelas extras, sendo assim fazia-se 
necess�rio uma aplicação para que a mesma fizesse apenas backup das tabelas extras que não tinham no 
...
(4, 'Com o intu�to de divulgar o Jovens Sarados mostrando eventos e com o intu�to de praticar flutter foi feito um app. Este app por sua vez ainda não está em produção.','Jovens Sarados App',2);
...
values
(1,'FAEPA','T�cnico em inform�tica','2016-10-09','T�cnico em inform�tica',null /*Note*/,'2008-05-13',false,false, 'https://site.faepa.br/assets/img/logo-faepa.png'/*urlLogo*/, null /*urlCompanyName*/),
(2,'Raizen','Analista de Suporte � Campo','2018-02-15','Analista de Suporte � Campo',null /*Note*/,'2016-10-10',true, true, 'https://logodownload.org/wp-content/uploads/2014/06/raizen-logo-1-1-2048x845.png'/*urlLogo*/, null /*urlCompanyName*/),
...
(4,'S�nior Sistemas','Desenvolvedor Java','2021-06-11','Desenvolvedor Java',null /*Note*/,'2021-02-17',false,false, 'https://portalerp.com/images/joomla/SENIOR_LOGO_New.png'/*urlLogo*/, null /*urlCompanyName*/),
...
-- BTG Pactual
(nextval('employment_activity_seq'),6,'Desenvolvimento de aplicação backend em C# .Net Core',''),
(nextval('employment_activity_seq'),6,'Desenvolvimento de aplicação frontend em React',''),
(nextval('employment_activity_seq'),6,'Manutenção/suporte em software legado Visual Basic',''),
...
select c2.idcourse , courseName, s.*  from coursetags c 
join course c2 on c2.idcourse = c.idcourse
left join smarttags s on s.idsmarttag  = c.idsmarttag
where upper(c2.coursename) like '%CORE%'
order by 2, 3